...
console.log("addOpacity"+event.style.opacity);
 ...
 function switch1(event, text1, text2) {
	...
	text1.innerText = "Senior Project Manager Brian Foster";
	text2.innerText = "Mayberry Electric is proud to win a NECA interiors Project Excellence Award";
 }
 ...
 function switch3(event, text1, text2) {
	...
	text1.innerText = "Senior Construction Manager Scott Mowers (Middle)";
